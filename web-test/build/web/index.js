...
// end include: /tmp/tmpg_4sawz5.js
// include: /tmp/tmpa5un7hd2.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpa5un7hd2.js
// include: /tmp/tmp1cjln0ul.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1cjln0ul.js
...
var ASM_CONSTS = {
  133280: () => { if (document.fullscreenElement) return 1; },  
 133326: () => { return document.getElementById('canvas').width; },  
 133378: () => { return parseInt(document.getElementById('canvas').style.width); },  
 133446: () => { document.exitFullscreen(); },  
 133473: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 133546: () => { if (document.fullscreenElement) return 1; },  
 133592: () => { return document.getElementById('canvas').width; },  
 133644: () => { return screen.width; },  
 133669: () => { document.exitFullscreen(); },  
 133696: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 133829: () => { return window.innerWidth; },  
 133855: () => { return window.innerHeight; },  
 133882: () => { if (document.fullscreenElement) return 1; },  
 133928: () => { return document.getElementById('canvas').width; },  
 133980: () => { return parseInt(document.getElementById('canvas').style.width); },  
 134048: () => { if (document.fullscreenElement) return 1; },  
 134094: () => { return document.getElementById('canvas').width; },  
 134146: () => { return screen.width; },  
 134171: () => { return window.innerWidth; },  
 134197: () => { return window.innerHeight; },  
 134224: () => { if (document.fullscreenElement) return 1; },  
 134270: () => { return document.getElementById('canvas').width; },  
 134322: () => { return screen.width; },  
 134347: () => { document.exitFullscreen(); },  
 134374: () => { if (document.fullscreenElement) return 1; },  
 134420: () => { return document.getElementById('canvas').width; },  
 134472: () => { return parseInt(document.getElementById('canvas').style.width); },  
 134540: () => { document.exitFullscreen(); },  
 134567: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 134625: () => { return screen.width; },  
 134650: () => { return screen.height; },  
 134676: () => { return window.screenX; },  
 134703: () => { return window.screenY; },  
 134730: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 134783: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 134854: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 134911: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 135167: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 135238: () => { if (document.fullscreenElement) return 1; },  
 135284: () => { return window.innerWidth; },  
 135310: () => { return window.innerHeight; },  
 135337: () => { if (document.pointerLockElement) return 1; }
};
